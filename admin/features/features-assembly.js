...
export class FeaturesAssembly {
  ...
  featureRegistry = {
    ...
    'platform-builds': { path: '/admin/features/omni-platform-expoter/platform-assembly.js', initFn: 'init' },
    'platform-targets': { path: '/admin/features/omni-platform-e/platform-assembly.js', initFn: 'init' },
